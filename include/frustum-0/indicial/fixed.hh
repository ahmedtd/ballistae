...
struct fixed
{
    ...
    typename std::enable_if<
        ct_ops::true_helper<UnusedTag>::value
        && sizeof...(Dims) == 2
    ...
    {
        std::size_t index = fixed_dimension_address(indices..., (list_end_tag()), Dims...);
...
auto fixed_elementwise_op(
    Op op,
    const fixed<Elt0, Dims...> &arg0,
...
auto operator+(
    const fixed<EltA, Dims...> &a,
    const fixed<EltB, Dims...> &b
)
{
