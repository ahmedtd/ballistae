...
load(
    "//third_party/cc/absl/absl:copts/GENERATED_copts.bzl",
    "ABSL_CLANG_CL_FLAGS",
...
ABSL_DEFAULT_COPTS = select({
    "//third_party/cc/absl/absl:windows": ABSL_MSVC_FLAGS,
    "//third_party/cc/absl/absl:llvm_compiler": ABSL_LLVM_FLAGS,
...
ABSL_TEST_COPTS = ABSL_DEFAULT_COPTS + select({
    "//third_party/cc/absl/absl:windows": ABSL_MSVC_TEST_FLAGS,
    "//third_party/cc/absl/absl:llvm_compiler": ABSL_LLVM_TEST_FLAGS,
    "//conditions:default": ABSL_GCC_TEST_FLAGS,
})

ABSL_DEFAULT_LINKOPTS = select({
    "//third_party/cc/absl/absl:windows": ABSL_MSVC_LINKOPTS,
    "//conditions:default": [],
})
