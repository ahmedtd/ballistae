...
$(augmk_d)/ballistae_geom_plugin_plane.so : d := $(augmk_d)
$(augmk_d)/ballistae_geom_plugin_plane.so : | src/libballistae/libballistae.so
$(augmk_d)/ballistae_geom_plugin_plane.so : | src/libguile_armadillo/libguile_armadillo.so
$(augmk_d)/ballistae_geom_plugin_plane.so : $($(augmk_d)_objs)
